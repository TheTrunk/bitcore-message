...
Bitcore implementation of Hush message signing and verification. [Why? Read this nice article: bitcoin message signing and verification](http://bitcoin.stackexchange.com/questions/3337/what-are-the-safety-guidelines-for-using-the-sign-message-feature/3339#3339). This is used to cryptographically prove that a certain message was signed by the holder of an address private key.

For more information refer to the [bitcore-message](https://github.com/TheTrunk/bitcore-message-hush) github repo.
...
```bash
npm install TheTrunk/bitcore-message-hush#master --save
```

For client-side projects:

```bash
bower install TheTrunk/bitcore-message-hush#master --save
```
